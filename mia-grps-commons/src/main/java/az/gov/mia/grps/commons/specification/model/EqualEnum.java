 ...
 *
 * @deprecated use {@link net.kaczmarzyk.spring.data.jpa.domain.Equal Equal} or
 * {@link net.kaczmarzyk.spring.data.jpa.domain.In In} specifications that
 * handle enums and other data types
 */
@Deprecated

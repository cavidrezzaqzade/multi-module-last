...
import static az.gov.mia.grps.commons.specification.Converter.ValuesRejectedException;

import org.springframework.data.jpa.domain.Specification;

import az.gov.mia.grps.commons.specification.model.EmptyResultOnTypeMismatch;
import az.gov.mia.grps.commons.specification.model.WithoutTypeConversion;

/**
 * <p>
 * Specifies the behaviour in case of type mismatch between HTTP param value and
 * the type on the property being filtered (e.g. when HTTP param = {@code "abc"}
 * and the type is {@code Long}).</p>
 *
 * <p>
 * To be used with {@code onTypeMismatch} property of {@code @Spec}
 * annotation.</p>
 *

...
/**
 * <p>
 * Filers with "is null" where clause (e.g. {@code where nickName is null}).</p>
 *
 * <p>
 * Does not require any http-parameters to be present, i.e. represents constant
 * part of the query.</p>
 *
 * @author Tomasz Kaczmarzyk
 *
 * @deprecated Consider using
 * {@link net.kaczmarzyk.spring.data.jpa.domain.Null Null}
 */
@Deprecated
